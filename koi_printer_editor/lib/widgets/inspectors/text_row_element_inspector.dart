                          ...
                          IconButton(
                            ...
                            onPressed: () {
                              ...
                              update(
                                context,
                                elementId,
                                element.copyWith(columns: newCols),
                              );
                            },
                          ),
                        ],
                      ...
                      Row(
                        children: [
                          Expanded(
                            child: TextFormField(
                              key: ValueKey(
                                'row_${elementId}_col_${idx}_ratio_${col.ratio}',
                              ),
                              initialValue: col.ratio.toString(),
                              decoration: const InputDecoration(
                                labelText: '比例宽度 (Ratio)',
                                border: OutlineInputBorder(),
                              ),
                          ...
                          Expanded(
                            child: DropdownButtonFormField<KoiTextAlign>(
                              key: ValueKey(
                                'row_${elementId}_col_${idx}_align_${col.align}',
                              ),
