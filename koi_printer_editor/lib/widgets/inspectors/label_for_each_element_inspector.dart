...
class LabelForEachElementInspector extends ElementInspectorBuilder<KoiLabelForEachElement> {
  @override
  Widget build(BuildContext context, String elementId, KoiLabelForEachElement element) {
    return Column(
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 12),
              const Text('提示：标签循环仅适合重复打印整张标签。如果要在单张标签内平铺列表，请使用绝对坐标循环(未实装)或小票模式。', style: TextStyle(color: Colors.redAccent, fontSize: 12)),
            ],
          ),
        ),
      ],
