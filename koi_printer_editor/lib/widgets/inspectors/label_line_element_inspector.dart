...
class LabelLineElementInspector extends ElementInspectorBuilder<KoiLabelLineElement> {
  @override
  Widget build(BuildContext context, String elementId, KoiLabelLineElement element) {
    return SingleChildScrollView(
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.stretch,
        children: [
          const Text('标签直线 (Line)', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14)),
          ...
          const Text('提示：水平线设置高度为线条粗细，垂直线设置宽度为线条粗细', style: TextStyle(color: Colors.grey, fontSize: 12)),
        ],
      ),
    );
  }
