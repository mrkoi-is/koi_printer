...
class LabelImageElementInspector
    extends ElementInspectorBuilder<KoiLabelImageElement> {
  @override
  Widget build(
    BuildContext context,
    String elementId,
    KoiLabelImageElement element,
  ) {
        ...
        children: [
          ...
          _buildNumberField(
            ...
            onChanged: (v) => update(
              context,
              elementId,
              element.copyWith(width: v == 0 ? null : v),
            ),
          ),
          const SizedBox(height: 16),
          ElevatedButton.icon(
            onPressed: () {
              ...
              ScaffoldMessenger.of(
                context,
              ).showSnackBar(const SnackBar(content: Text('此处需集成图片选择器')));
            },
