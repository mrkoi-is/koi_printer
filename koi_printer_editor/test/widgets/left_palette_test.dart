    ...
    testWidgets('Renders layer tree elements', (tester) async {
      ...
      state.loadManifest(
        ...
        [
          ...
          EditorElement(
            id: '4',
            element: const KoiQrCodeElement(data: 'qr'),
          ),
          EditorElement(
            id: '5',
            element: const KoiBarcodeElement(data: 'bar'),
          ),
          EditorElement(
            id: '6',
            element: const KoiTextRowElement(columns: []),
          ),
          EditorElement(id: '7', element: const KoiSpacerElement(lines: 1)),
          EditorElement(
            id: '8',
            element: const KoiLabelSetupElement(widthMm: 10, heightMm: 10),
          ),
          EditorElement(
            id: '9',
            element: const KoiPositionedTextElement(text: 'pos', x: 0, y: 0),
          ),
          EditorElement(
            id: '10',
            element: const KoiLabelBoxElement(
              x: 0,
              y: 0,
              width: 10,
              height: 10,
          ...
          EditorElement(
            id: '11',
            element: const KoiPositionedBarcodeElement(
              data: 'bpos',
              x: 0,
              y: 0,
            ),
          ...
          EditorElement(
            id: '12',
            element: const KoiPositionedQrCodeElement(data: 'qpos', x: 0, y: 0),
          ),
          EditorElement(
            id: '13',
            element: const KoiLabelLineElement(
              x: 0,
              y: 0,
              width: 10,
              height: 1,
          ...
          EditorElement(
            id: '14',
            element: const KoiLabelReverseElement(
              x: 0,
              y: 0,
              width: 10,
              height: 10,
          ...
          EditorElement(
            id: '16',
            element: const KoiLabelPrintElement(copies: 1),
          ),
          EditorElement(
            id: '17',
            element: const KoiLabelForEachElement(listKey: 'k', templates: []),
          ),
