...
void main() {
  final image =
      img.Image(width: 15, height: 2, numChannels: 4)
        ..setPixelRgba(0, 0, 0, 0, 0, 255) // Black
        ..setPixelRgba(1, 0, 255, 255, 255, 255); // White
    ...
    for (var x = 0; x < targetWidth; x += 8) {
      ...
      for (var bit = 0; bit < 8; bit++) {
        ...
        if (realX < widthPx) {
          ...
          // Invert and check threshold
          // (white = 255, lum=255. Inverted lum = 0. 0 > 127 is false)
