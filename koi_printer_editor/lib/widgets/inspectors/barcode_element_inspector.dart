...
class BarcodeElementInspector extends ElementInspectorBuilder<KoiBarcodeElement> {
  @override
  Widget build(BuildContext context, String elementId, KoiBarcodeElement element) {
    return Column(
      ...
      children: [
        ...
        Padding(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.stretch,
            children: [
              const Text('几何与对齐 (Geometry)', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 13, color: Colors.blue)),
              const SizedBox(height: 12),
              ...
              const SizedBox(height: 16),
              const Text('宽度比例', style: TextStyle(fontSize: 12, color: Colors.grey)),
              Slider(
              ...
              const SizedBox(height: 16),
              const Text('条码高度 (点数)', style: TextStyle(fontSize: 12, color: Colors.grey)),
              Slider(
